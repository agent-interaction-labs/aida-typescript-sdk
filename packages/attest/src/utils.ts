/**
 * AIDA Agent SDK — Utility functions.
...
/**
 * Create a JWK representation of an Ed25519 public key (RFC 8037).
 */
export function publicKeyToJWK(publicKey: Uint8Array): {
  kty: 'OKP';
  crv: 'Ed25519';
  x: string;
} {
